/*
	...
	This project was Created by: Franco119 - Francisco Alonso Torres Rosa - SV
...
int main() {
	...
	al_set_window_title(ventana, "Proyecto MetaTetris");
...
int menu_game(){
	...
	*/
	...
	while (true) {
		...
		al_draw_text(dirt_chunk, al_map_rgb( 255, 255, 255), 200, 50, NULL, ("TetrisMetaChafa V1.0"));

		al_draw_text(dirt_chunk, al_map_rgb(255, 255, 255), 200, 150, NULL, ("Puntuacion Maxima: " + to_string(MaxPoints)).c_str());
